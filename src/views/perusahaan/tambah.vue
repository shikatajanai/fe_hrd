...
//import api
//import router
import { storeCompany } from '@/api/index'
...
const submitForm = async () => {
  ...
  //store company
  try {
    //jadikan form data sebagai json
    //console log name, address
    console.log(form);
    const response = await storeCompany(form);
    console.log(response);
    //muncul alert bahwa perusahaan berhasil disimpan, saat diklik ok, akan diarahkan ke halaman data perusahaan
    alert('Company saved successfully');
    router.push({ name: 'DataPerusahaan' });
  } catch (error) {
